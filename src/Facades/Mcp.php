 ...
 * @method static void oAuthRoutesFor(string $client, \Closure|array $handler, array|string $middleware = 'web', string|null $connectUri = null, string|null $callbackUri = null, string|null $clientMetadataUri = null)
